...
namespace TDAmeritradeAPI
{
    ...
    class MyCustomResolver : DefaultJsonTypeInfoResolver
    {
        public override JsonTypeInfo GetTypeInfo(Type type, JsonSerializerOptions options)
        {
            ...
            JsonTypeInfo<Instrument> jti = JsonTypeInfo.CreateJsonTypeInfo<Instrument>(options);
            jti.CreateObject = () => new Instrument();

            JsonPropertyInfo propId = jti.CreateJsonPropertyInfo(typeof(int), "ID");
